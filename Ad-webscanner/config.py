...
# --- AI Firewall Simulation Settings ---

# Threshold for anomaly detection (0.0 to 1.0)

# Lower means more strict; higher means more tolerant
ANOMALY_THRESHOLD = 0.15 

# Weighted impact of different actions
THREAT_WEIGHTS = {
    "port_scan": 0.2,
...
# --- Advanced AI Defense Settings ---
WMA_DECAY = 0.3  # How much the previous threat level persists
THRESHOLD_CRITICAL = 0.7  # Score above this = Instant Block
THRESHOLD_WARNING = 0.4   # Score above this = Rate Limit / Log

# Granular Threat Impact (0.0 to 1.0)
THREAT_IMPACT = {
    "recon_dns": 0.05,
    "port_scan_small": 0.1,
    "port_scan_large": 0.4,
...
BRUTE_FORCE_LIMIT = 5      # Failed attempts before block
EXFIL_LIMIT_MB = 100       # Outbound data limit

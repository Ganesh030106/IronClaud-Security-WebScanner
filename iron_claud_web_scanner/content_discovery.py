    ...
    def extract_comments(self, html, url):
        ...
        for c in comments:
            ...
            if any(k in comment_text for k in interesting_keywords) or len(comment_text) > 10:
                ...
                findings.append(f"Interesting Comment on {url}: ")
        return findings
            ...
            for ext in MUTATION_EXTENSIONS:
                ...
                try:
                    ...
                    if resp.status_code == 200:
                         # Verify it's not a custom 404 by checking content type isn't HTML usually
    ...
    def check_page_security(self, html, url):
        ...
        for script in scripts:
            if script.string: # Inline script
                ...
                # We note it, but don't fetch external JS to keep it fast
                pass

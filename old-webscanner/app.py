...
st.title("🛡️ Web Application Security Scanner")
...
if start_scan and target_url:
    if not (target_url.startswith("http://") or target_url.startswith("https://")):
        ...
        try:
            ...
            tab_recon, tab_vuln, tab_crawl, tab_export = st.tabs([
                "💡 Reconnaissance", "🚨 Vulnerability Report", "🕸️ Crawl Data", "📄 Raw JSON"
            ])
